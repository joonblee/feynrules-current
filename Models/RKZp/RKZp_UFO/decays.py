...
Decay_b = Decay(name = 'Decay_b',
                ...
                partial_widths = {(P.W__minus__,P.t):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.Zp,P.s):'((MB**2 - MZp**2)*(3*gbs**2*MB**2 + (3*gbs**2*MB**4)/MZp**2 - 6*gbs**2*MZp**2))/(96.*cmath.pi*abs(MB)**3)'})
...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.b,P.b__tilde__):'((-6*gbb**2*MB**2 + 6*gbb**2*MZp**2)*cmath.sqrt(-4*MB**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.b,P.s__tilde__):'((-MB**2 + MZp**2)*(-3*gbs**2*MB**2 - (3*gbs**2*MB**4)/MZp**2 + 6*gbs**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.mu__minus__,P.mu__plus__):'(gmm**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.b__tilde__):'((-MB**2 + MZp**2)*(-3*gbs**2*MB**2 - (3*gbs**2*MB**4)/MZp**2 + 6*gbs**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.t,P.t__tilde__):'((-6*gbb**2*MT**2 + 6*gbb**2*MZp**2)*cmath.sqrt(-4*MT**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.vm,P.vm__tilde__):'(gmm**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)'})

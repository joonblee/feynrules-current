...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.u,P.d__tilde__):'((-MD**2 + MW**2)*((-3*ee**2*MD**2)/(2.*sw**2) - (3*ee**2*MD**4)/(2.*MW**2*sw**2) + (3*ee**2*MW**2)/sw**2))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_d = Decay(name = 'Decay_d',
                particle = P.d,
                partial_widths = {(P.W__minus__,P.u):'((MD**2 - MW**2)*((3*ee**2*MD**2)/(2.*sw**2) + (3*ee**2*MD**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2))/(96.*cmath.pi*abs(MD)**3)'})
